...
from semantic_fmri.utils import (
    ROI_LABELS_TO_TEST, ensure_dir, extract_roi_timeseries,
...
def main():
    ...
    baseline_cols = ["word_count_hrf", "mean_char_len_hrf", "total_chars_hrf", "time_TR_hrf"]
    ...
    for i, story in enumerate(stories, start=1):
        ...
        for roi, y in roi_ts.items():
            for model_name, X in model_mats.items():
                cv_r2, cv_r, n_used = cross_validated_prediction(
    ...
    summary = (
        ...
        .agg(mean_cv_r=("cv_r", "mean"), sd_cv_r=("cv_r", "std"),
             mean_cv_r2=("cv_r2", "mean"), sd_cv_r2=("cv_r2", "std"), n=("cv_r", "count"))
